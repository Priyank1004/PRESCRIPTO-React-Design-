...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrep bg-primary rounded-lg px-6 md:px:10 lg:px-20'>
      {/* ------------- Left side ----------------------*/}
      <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
        ...
        <a className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto md:md-0 hover:scale-105 transition-all duration-300 ml-0' href='#speciality'>
